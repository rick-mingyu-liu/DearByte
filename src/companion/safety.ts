...
// gentler, a false negative misses a crisis. Replace with a classifier once we
// have real traffic to measure against.
const CRISIS_PATTERNS = [
  /想死|不想活|活不下去|撑不下去|自杀|轻生|结束(自己的)?生命|了结自己|消失了?也挺好|不如消失|离开这个世界/,
