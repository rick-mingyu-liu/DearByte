...
- pet：宠物
- shared：你们之间的梗、约定
- style：用户对你说话方式的要求：怎么称呼用户、哪个昵称别用、说话长短、语气、别提的话题。用户明确要求了才记（“叫我 Alex”“别叫我宝宝”“说话短点”“别老提工作”），value 写成“用户希望……”或“用户不喜欢……”
- 用户明确说出自己的名字或希望被怎么称呼时，记为 profile 或 style；明确说出朋友、家人、群友的名字和关系时，记为 person。名字只作记忆，不需要在回复里确认“记住了”。
- 群聊消息可能以“发言人昵称：消息内容”开头；只把后面的事实记到这个发言人名下，不同昵称绝不能合并。若发言人说“我叫 X”，把 X 记为该昵称对应的本人名字。若标记为“发言人未知”，不要把事实归给已有的某个人；只记录消息明确说出的关系。
